 ...
 */
@Entity
@Table(name = "scl_examencoprologia", catalog = "labclinicodb", schema = "UESBAD", uniqueConstraints = {
...
public class SclExamencoprologia implements Serializable {
    ...
    public String toString() {
        return "persistencialab.entities.SclExamencoprologia[ sclExamencoprologiaPK=" + sclExamencoprologiaPK + " ]";
    }
