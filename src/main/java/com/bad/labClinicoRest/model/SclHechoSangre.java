 ...
 */
@Entity
@Table(name = "scl_hecho_sangre", catalog = "labclinicodb", schema = "UESBAD", uniqueConstraints = {
    @UniqueConstraint(columnNames = {"id_paciente", "id_pais", "id_depto", "id_municipio", "id_ordenexamen", "id_hematologia"})})
@NamedQueries({
...
public class SclHechoSangre implements Serializable {
    ...
    public SclHechoSangre(int idPaciente, String idPais, int idDepto, int idMunicipio, int idOrdenexamen, int idHematologia) {
        this.sclHechoSangrePK = new SclHechoSangrePK(idPaciente, idPais, idDepto, idMunicipio, idOrdenexamen, idHematologia);
    }
    ...
    public BigInteger getCantExamen() {
        return cantExamen;
    }

    public void setCantExamen(BigInteger cantExamen) {
    ...
    public String toString() {
        return "persistencialab.entities.SclHechoSangre[ sclHechoSangrePK=" + sclHechoSangrePK + " ]";
    }
